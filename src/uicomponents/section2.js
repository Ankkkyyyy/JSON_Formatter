    ...
    <Center>
         <Heading textAlign="center" color="#6C62CA" as="u"> Learn About JSON</Heading>
            ...
            <HStack>
              ...
              <Center>
    <Text textAlign="start" mt="20px" width={['100%','100%','60%']}  > JSON or JavaScript Object Notation is a language-independent open data format that uses human-readable text to express data objects consisting of attribute-value pairs.
